    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('study_plan_created', 'Study Plan Created'), ('study_plan_updated', 'Study Plan Updated'), ('other', 'Other')], default='study_plan_created', max_length=50)),
                ('title', models.CharField(max_length=200)),
